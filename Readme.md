...
- 📨 Для поддержания связи писать в телеграм [Telegram Badge](https://img.shields.io/static/v1?message=<@Danon12n>&color=<blue>)]или писать на почту ```nechitaylodv@yandex.ru```.
